/**
 * Straw man is treated as a line, it uses the left-most and right-most coordinate to position, 
 * the height of the straw man has already been set as a constant.
 * 
 * Straw man uses singleton implementation
 * 
 */

package game.strawman;
